...
class SimpleMapTest {
    ...
    @Test
    void whenPutNullThenNull() {
        map.put(null, "1");
        map.put(null, "2");
        assertThat(map.get(null)).isEqualTo("1");
    }

    @Test
    void whenRemoveAllAndGet1() {
        map.remove(1);
        map.remove(2);
        map.remove(3);
        map.remove(4);
    ...
    @Test
    void whenRemoveAndThenGet() {
        map.remove(2);
        assertThat(map).hasSize(3).doesNotContain(2);
    }

    @Test
    void whenExpandThenGet() {
        map.put(5, "5");
        map.put(0, "0");
        map.put(6, "6");
        map.put(7, "7");
